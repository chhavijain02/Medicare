...
import video from "../assets/images/vidoe.png";
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            md:leading-[70px]"
                ...
                <p className="text__para mb-7">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Commodi, iure possimus odio eveniet sequi animi debitis
                  quibusdam enim nemo dolorem nostrum officia perspiciatis sint
                  eius tenetur, amet accusantium error odit?
                </p>
      ...
      <section>
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            ...
            [#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-buttonColor hover:border-none"
                >
      ...
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            {/* --------- Feature Image---------- */}
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0 mr-5">
              <img src={video} className="w-3/4" alt="" />
